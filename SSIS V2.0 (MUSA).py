...
#======================================== FRAMES AND LABELS =======================================#
    ...
    headlabel = Label(root, text="", bg="maroon", fg="white", font=("Arial", 30, "bold"), anchor="center")
...
#======================================== STUDENT LIST FEATURES =======================================#
        ...
        refreshbut = Button(displayroot, text="REFRESH", command=lambda: [schidno.set(""), searchStudent()], relief=FLAT, font=("Arial", 12, "bold"), bg="black", fg="white", activeforeground="black", activebackground="white")
...
#======================================== COURSE LIST FEATURES =======================================#
        ...
        searchbut.place(x=305, height=30, y=15, width=80)
        refreshbut = Button(displayroot, text="REFRESH", command=lambda: [schccode.set(""), searchCourse()], relief=FLAT, font=("Arial", 12, "bold"), bg="black", fg="white", activeforeground="black", activebackground="gold")
        refreshbut.place(x=390, height=30, y=15, width=80)
